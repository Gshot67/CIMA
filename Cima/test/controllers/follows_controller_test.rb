...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference("Follow.count") do
      post follows_url, params: { follow: { follower: @follow.follower, seguito: @follow.seguito } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { follower: @follow.follower, seguito: @follow.seguito } }
