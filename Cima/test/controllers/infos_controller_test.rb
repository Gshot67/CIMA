...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference("Info.count") do
      post infos_url, params: { info: { bio: @info.bio, certificazione: @info.certificazione, foto: @info.foto, nome: @info.nome, tipo: @info.tipo, user_id: @info.user_id, username: @info.username } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { bio: @info.bio, certificazione: @info.certificazione, foto: @info.foto, nome: @info.nome, tipo: @info.tipo, user_id: @info.user_id, username: @info.username } }
